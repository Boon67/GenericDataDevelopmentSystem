function RB_RuleEditor_wifi_TempHighAlert_Service (req, resp) {
    ...
    if ((tryParse(reqObject.body).Temperature > "50")) {
	  callAlertProvider0();
  }
    ...
    function callAlertProvider0 () {
        ...
        ClearBlade.Code().execute("alert_service", Object.assign({ruleName: 'wifi_TempHighAlert'}, req.params), true, function (err, body){
            if(err) {
    ...
    function callAlertProvider1 () {
        ...
        ClearBlade.init({request:req});
        ClearBlade.Code().execute("alert_log", Object.assign({ruleName: 'wifi_TempHighAlert'}, req.params), true, function (err, body){
            if(err) {
